...
T = TypeVar("T", bound="PostApiAuthPasskeyGenerateAuthenticateOptionsResponse200AuthenticatorSelection")


@_attrs_define
class PostApiAuthPasskeyGenerateAuthenticateOptionsResponse200AuthenticatorSelection:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_auth_passkey_generate_authenticate_options_response_200_authenticator_selection = cls(
