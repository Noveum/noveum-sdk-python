...
T = TypeVar("T", bound="PostApiV1DatasetsByDatasetSlugItemsBodyItemsItemContentConversationContext")


@_attrs_define
class PostApiV1DatasetsByDatasetSlugItemsBodyItemsItemContentConversationContext:
    """ """
