...
T = TypeVar("T", bound="PostApiAuthSignInEmailOtpResponse200")


@_attrs_define
class PostApiAuthSignInEmailOtpResponse200:
    """
    Attributes:
        user (User | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_auth_sign_in_email_otp_response_200 = cls(
            user=user,
            session=session,
        )

        post_api_auth_sign_in_email_otp_response_200.additional_properties = d
        return post_api_auth_sign_in_email_otp_response_200
