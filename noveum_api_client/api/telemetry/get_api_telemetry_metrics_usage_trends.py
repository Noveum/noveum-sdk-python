...
from ...models.get_api_telemetry_metrics_usage_trends_interval import GetApiTelemetryMetricsUsageTrendsInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsUsageTrendsInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/usage-trends",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsUsageTrendsInterval | Unset):
        time_zone (str | Unset):
