...
from ...models.get_api_telemetry_metrics_error_rate_interval import GetApiTelemetryMetricsErrorRateInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsErrorRateInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/error-rate",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsErrorRateInterval | Unset):
        time_zone (str | Unset):
