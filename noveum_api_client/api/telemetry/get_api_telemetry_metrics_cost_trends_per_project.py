...
from ...models.get_api_telemetry_metrics_cost_trends_per_project_interval import (
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsCostTrendsPerProjectInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/cost-trends-per-project",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsCostTrendsPerProjectInterval | Unset):
        time_zone (str | Unset):
