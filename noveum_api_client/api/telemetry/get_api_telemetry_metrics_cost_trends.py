...
from ...models.get_api_telemetry_metrics_cost_trends_interval import GetApiTelemetryMetricsCostTrendsInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsCostTrendsInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/cost-trends",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsCostTrendsInterval | Unset):
        time_zone (str | Unset):
