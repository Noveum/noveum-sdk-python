...
from ...models.get_api_telemetry_metrics_cost_by_provider_interval import GetApiTelemetryMetricsCostByProviderInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsCostByProviderInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/costByProvider",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsCostByProviderInterval | Unset):
        time_zone (str | Unset):
