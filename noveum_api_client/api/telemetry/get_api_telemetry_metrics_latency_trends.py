...
from ...models.get_api_telemetry_metrics_latency_trends_interval import GetApiTelemetryMetricsLatencyTrendsInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsLatencyTrendsInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/latency-trends",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get latency trends time series
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsLatencyTrendsInterval | Unset):
        time_zone (str | Unset):
