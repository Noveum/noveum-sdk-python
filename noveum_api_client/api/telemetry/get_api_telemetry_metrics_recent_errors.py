...
from ...models.get_api_telemetry_metrics_recent_errors_interval import GetApiTelemetryMetricsRecentErrorsInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsRecentErrorsInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/recent-errors",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsRecentErrorsInterval | Unset):
        time_zone (str | Unset):
