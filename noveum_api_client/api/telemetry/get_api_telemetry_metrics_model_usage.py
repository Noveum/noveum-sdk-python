...
from ...models.get_api_telemetry_metrics_model_usage_interval import GetApiTelemetryMetricsModelUsageInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsModelUsageInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/model-usage",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsModelUsageInterval | Unset):
        time_zone (str | Unset):
