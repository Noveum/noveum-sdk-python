...
from ...models.get_api_telemetry_metrics_top_projects_tokens_interval import (
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsTopProjectsTokensInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/top-projects-tokens",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsTopProjectsTokensInterval | Unset):
        time_zone (str | Unset):
