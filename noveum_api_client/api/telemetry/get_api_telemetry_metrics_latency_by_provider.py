...
from ...models.get_api_telemetry_metrics_latency_by_provider_interval import (
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsLatencyByProviderInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/latencyByProvider",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsLatencyByProviderInterval | Unset):
        time_zone (str | Unset):
