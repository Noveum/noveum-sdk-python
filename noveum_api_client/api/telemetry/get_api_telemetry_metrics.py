...
from ...models.get_api_telemetry_metrics_interval import GetApiTelemetryMetricsInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsInterval | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsInterval | Unset):
        time_zone (str | Unset):
