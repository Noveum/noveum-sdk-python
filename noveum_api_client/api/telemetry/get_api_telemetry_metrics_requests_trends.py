...
from ...models.get_api_telemetry_metrics_requests_trends_interval import GetApiTelemetryMetricsRequestsTrendsInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsRequestsTrendsInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/requests-trends",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get request trends time series
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsRequestsTrendsInterval | Unset):
        time_zone (str | Unset):
