...
from ...models.get_api_telemetry_metrics_slowest_requests_interval import GetApiTelemetryMetricsSlowestRequestsInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsSlowestRequestsInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/slowest-requests",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsSlowestRequestsInterval | Unset):
        time_zone (str | Unset):
