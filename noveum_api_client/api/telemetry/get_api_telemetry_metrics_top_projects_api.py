...
from ...models.get_api_telemetry_metrics_top_projects_api_interval import GetApiTelemetryMetricsTopProjectsApiInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsTopProjectsApiInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/top-projects-api",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsTopProjectsApiInterval | Unset):
        time_zone (str | Unset):
