...
from ...models.get_api_telemetry_metrics_with_trends_interval import GetApiTelemetryMetricsWithTrendsInterval
...
def _get_kwargs(
    *,
    ...
    interval: GetApiTelemetryMetricsWithTrendsInterval | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/telemetry/metrics/with-trends",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get project metrics with trends
    ...
    Args:
        ...
        end_time (str | Unset):
        project (str | Unset):
        interval (GetApiTelemetryMetricsWithTrendsInterval | Unset):
        time_zone (str | Unset):
