...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/payments/create-customer-portal-link",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Create a customer portal link
     ...
     Creates a customer portal link for the customer or team. If a purchase is provided, the link will be
    created for the customer of the purchase.
